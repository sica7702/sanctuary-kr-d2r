...
const DYNAMIC_SKILL_ELIGIBLE=new Set(['ring','amulet','circlet','gloves','classarmor','melee','bow','crossbow','jav','polearm','claw','orb','wand','caster']);
...
const MAX_CAPS={
 ring:{fcr:10,ar:120,str:20,dex:15,energy:15,life:40,mana:90,rep:9,ll:8,ml:6,mpk:1,mregen:10,allres:11,fire:30,light:30,cold:30,poison:30,mindmg:9,maxdmg:4,mf:15,gf:40,plr:25,dr:2,mdr:2,maxstam:20,lightradius:5},
 amulet:{classskill:2,skilltab:2,fcr:10,str:30,dex:20,energy:20,life:60,mana:90,rep:10,ll:6,ml:8,mregen:10,allres:20,fire:40,light:40,cold:40,poison:50,mf:25,gf:80,mindmg:9,maxdmg:4,plr:75,dr:4,mdr:6,dtm:12,ar:20,maxstam:20,lightradius:5},
 circlet:{classskill:2,skilltab:2,fcr:20,frw:30,sockets:2,str:30,dex:20,energy:20,life:60,mana:90,rep:10,ll:8,ml:8,ar:120,ed:30,mindmg:9,maxdmg:8,mpk:5,allres:20,fire:40,light:40,cold:40,poison:40,mf:25,gf:80,plr:75,dr:7,mdr:6,visionary:99,maxstam:20},
 gloves:{skilltab:2,ias:20,str:15,dex:15,ar:20,mana:40,rep:5,ll:3,ml:3,fire:30,light:30,cold:30,poison:30,mf:25,gf:80,maxstam:10},
 boots:{frw:30,fhr:10,dex:9,mana:40,rep:5,maxstam:30,stamregen:50,eddef:200,fire:40,light:40,cold:40,poison:40,gf:80,mf:25},
 belt:{fhr:24,str:30,life:60,mana:20,rep:9,maxstam:30,eddef:200,fire:30,light:30,cold:30,poison:30,gf:80},
